...
{
    public class PageReplacerLastRecentlyUsed : IPageReplacer
    {
        public PageReplacerLastRecentlyUsed(PR_SimulatorModel simulatorModel, ObservableCollection<string> parameters)
        {
